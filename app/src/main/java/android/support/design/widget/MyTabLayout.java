 ...
 * done through {@link MyTabLayout.Tab} instances. You create tabs via {@link #newTab()}. From there you can
 * change the tab's label or icon via {@link MyTabLayout.Tab#setText(int)} and {@link MyTabLayout.Tab#setIcon(int)}
 * respectively. To display the tab, you need to add it to the layout via one of the
 * {@link #addTab(MyTabLayout.Tab)} methods. For example:
 * <pre>
 * TabLayout tabLayout = ...;
 ...
 * </pre>
 * You should set a listener via {@link #setOnTabSelectedListener(MyTabLayout.OnTabSelectedListener)} to be
...
public class MyTabLayout extends HorizontalScrollView {
    ...
    /**
     * Create and return a new {@link MyTabLayout.Tab}. You need to manually add this using
     * {@link #addTab(MyTabLayout.Tab)} or a related method.
     *
     * @return A new Tab
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<MyTabLayout.Tab> i = mTabs.iterator(); i.hasNext(); ) {
