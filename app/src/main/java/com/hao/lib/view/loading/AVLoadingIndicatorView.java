package com.hao.lib.view.loading;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int def = DisplayUtils.dip2px(context, 48);
        mMinWidth = def;
        mMaxWidth = def;
        mMinHeight = def;
        mMaxHeight = def;
        ...
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AVLoadingIndicatorView);
            ...
            mIndicatorColor = a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, mIndicatorColor);
            a.recycle();
        }
